...
describe("test for notifications.js", () => {
	it("uses the id 5debd764a7c57c7839d722e9 and verifies that correct data is returned", () => {
		const result = [
			{
	...
	it("verifies data has a normalized array - result", () => {
		const data = [
	...
	it("verifies data has a normalized users entity", () => {
		const data = {
			age: 25,
	...
	it("verifies data has a normalized messages entity", () => {
		const data = {
		...
		expect(mesage).toEqual(data);
	});
	 it("verifies data has a normalized notifications entity", () => {
		 const data = {
			 author: "5debd764f8452ef92346c772",
			 context: "3068c575-d619-40af-bf12-dece1ee18dd3",
			 id: "5debd7642e815cd350407777"
		 };
		 const notification = normalizedData.entities.notifications["5debd764f8452ef92346c772"];
